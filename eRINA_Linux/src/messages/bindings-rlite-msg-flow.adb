...
package body Bindings.Rlite.Msg.Flow is
   ...
   function Serialize (Self : in Request) return Byte_Buffer is
      ...
      Flow_Spec : constant Byte_Buffer (1 .. Self.Flow_Spec'Size / 8) with
         Address => Self.Flow_Spec'Address,
         Import,
         Volatile;

      Upper_Ipcp_Id : constant Byte_Buffer
      (1 .. Self.Upper_Ipcp_Id'Size / 8) with
         Address => Self.Upper_Ipcp_Id'Address,
         Import,
         Volatile;

      Local_Port : constant Byte_Buffer (1 .. Self.Local_Port'Size / 8) with
         Address => Self.Local_Port'Address,
         Import,
         Volatile;

      Local_Cep : constant Byte_Buffer (1 .. Self.Local_Cep'Size / 8) with
         Address => Self.Local_Cep'Address,
         Import,
         Volatile;

      Uid : constant Byte_Buffer (1 .. Self.Uid'Size / 8) with
         Address => Self.Uid'Address,
         Import,
         Volatile;

      Cookie : constant Byte_Buffer (1 .. Self.Cookie'Size / 8) with
         Address => Self.Cookie'Address,
         Import,
         Volatile;
      ...
      Local_Appl_Size_Ptr : constant Byte_Buffer
      (1 .. Local_Appl_Size'Size / 8) with
         Address => Local_Appl_Size'Address,
         Import,
         Volatile;
      ...
      Remote_Appl_Size_Ptr : constant Byte_Buffer
      (1 .. Remote_Appl_Size'Size / 8) with
         Address => Remote_Appl_Size'Address,
         Import,
         Volatile;
   ...
   function Serialize (Self : Response) return Byte_Buffer is
      ...
      Kevent_Id : constant Byte_Buffer (1 .. Self.Kevent_Id'Size / 8) with
         Address => Self.Kevent_Id'Address,
         Import,
         Volatile;
