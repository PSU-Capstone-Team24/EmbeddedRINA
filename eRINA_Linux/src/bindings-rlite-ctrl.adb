...
begin
   ...
   begin
      ...
      if fd < 0 then
            Debug.Print ("Open_Port_Common", "Could not open a file descriptor to rLite IO", Debug.Error);
            return OS.Invalid_FD;
      end if;
      ...
      if ret < 0 then
         Debug.Print ("Open_Port_Common", "Could not write to rLite IO", Debug.Error);
         return OS.Invalid_FD;
      end if;
