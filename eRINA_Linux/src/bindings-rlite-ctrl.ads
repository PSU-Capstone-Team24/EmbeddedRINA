...
package Bindings.Rlite.Ctrl is
   ...
   package IPCP_Id_Map is new Ada.Containers.Hashed_Maps
     (Key_Type => Bounded_String, Element_Type => Rl_Ipcp_Id_T,
      Hash     => Names.Hash, Equivalent_Keys => "=");
   ...
   procedure Rl_Msg_Free
     (numtables : System.Address; num_entries : Unsigned_32;
      msg       : System.Address);
   ...
   RLITE_IOCTL_FLOW_BIND : constant Unsigned_32 := 1_074_310_912;
