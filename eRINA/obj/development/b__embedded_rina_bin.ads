...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_eRINA" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f3179dbb#;
   pragma Export (C, u00001, "eRINAB");
   ...
   u00114 : constant Version_32 := 16#6c899da8#;
   pragma Export (C, u00114, "bindingsS");
   u00115 : constant Version_32 := 16#bc34ac54#;
   pragma Export (C, u00115, "bindings__rliteS");
   u00116 : constant Version_32 := 16#6c1b1f5f#;
   pragma Export (C, u00116, "bindings__rlite__apiB");
   u00117 : constant Version_32 := 16#0a8cda55#;
   pragma Export (C, u00117, "bindings__rlite__apiS");
   u00118 : constant Version_32 := 16#619c45a9#;
   pragma Export (C, u00118, "bindings__rlite__ctrlB");
   u00119 : constant Version_32 := 16#288fe495#;
   pragma Export (C, u00119, "bindings__rlite__ctrlS");
   u00120 : constant Version_32 := 16#a9f9acfa#;
   pragma Export (C, u00120, "bindings__rlite__msgS");
   u00121 : constant Version_32 := 16#90fa1f1c#;
   pragma Export (C, u00121, "buffersB");
   u00122 : constant Version_32 := 16#8687b888#;
   pragma Export (C, u00122, "buffersS");
   u00123 : constant Version_32 := 16#c12296fa#;
   pragma Export (C, u00123, "debugB");
   u00124 : constant Version_32 := 16#3eb29bba#;
   pragma Export (C, u00124, "debugS");
   u00125 : constant Version_32 := 16#883ea5ad#;
   pragma Export (C, u00125, "namesB");
   u00126 : constant Version_32 := 16#b7d87a65#;
   pragma Export (C, u00126, "namesS");
   u00127 : constant Version_32 := 16#fe1ffede#;
   pragma Export (C, u00127, "ada__strings__boundedB");
   u00128 : constant Version_32 := 16#89c18940#;
   pragma Export (C, u00128, "ada__strings__boundedS");
   u00129 : constant Version_32 := 16#7ec26662#;
   pragma Export (C, u00129, "ada__strings__superboundedB");
   u00130 : constant Version_32 := 16#da6addee#;
   pragma Export (C, u00130, "ada__strings__superboundedS");
   ...
   u00133 : constant Version_32 := 16#acee74ad#;
   ...
   u00139 : constant Version_32 := 16#ac2ae7c3#;
   pragma Export (C, u00139, "bindings__rlite__msg__registerB");
   u00140 : constant Version_32 := 16#77229741#;
   pragma Export (C, u00140, "bindings__rlite__msg__registerS");
   u00141 : constant Version_32 := 16#c8827b54#;
   pragma Export (C, u00141, "system__strings__stream_opsB");
   u00142 : constant Version_32 := 16#ec029138#;
   pragma Export (C, u00142, "system__strings__stream_opsS");
   u00143 : constant Version_32 := 16#95642423#;
   pragma Export (C, u00143, "ada__streams__stream_ioB");
   u00144 : constant Version_32 := 16#55e6e4b0#;
   pragma Export (C, u00144, "ada__streams__stream_ioS");
   u00145 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00145, "system__communicationB");
   u00146 : constant Version_32 := 16#5f55b9d6#;
   pragma Export (C, u00146, "system__communicationS");
   u00147 : constant Version_32 := 16#416d4c4d#;
   pragma Export (C, u00147, "bindings__rlite__commonS");
   u00148 : constant Version_32 := 16#69f6ee6b#;
   ...
   u00150 : constant Version_32 := 16#302de9ab#;
   pragma Export (C, u00150, "bindings__rlite__listS");
   u00151 : constant Version_32 := 16#b7636748#;
   pragma Export (C, u00151, "bindings__rlite__msg__flowB");
   u00152 : constant Version_32 := 16#c234900f#;
   pragma Export (C, u00152, "bindings__rlite__msg__flowS");
   u00153 : constant Version_32 := 16#f2bb62e5#;
   pragma Export (C, u00153, "bindings__rlite__utilsS");
   u00154 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00154, "gnatS");
   u00155 : constant Version_32 := 16#728833ee#;
   pragma Export (C, u00155, "gnat__os_libS");
   u00156 : constant Version_32 := 16#7801ab0f#;
   ...
   --  bindings%s
   --  bindings.rlite%s
   --  bindings.rlite.common%s
   --  bindings.rlite.list%s
   --  bindings.rlite.utils%s
   --  debug%s
   --  debug%b
   --  buffers%s
   --  buffers%b
   ...
   --  names%s
   --  names%b
   --  bindings.rlite.msg%s
   --  bindings.rlite.msg.flow%s
   --  bindings.rlite.msg.flow%b
   --  bindings.rlite.msg.register%s
   --  bindings.rlite.msg.register%b
   --  bindings.rlite.api%s
   --  bindings.rlite.ctrl%s
   --  bindings.rlite.ctrl%b
   --  bindings.rlite.api%b
   --  eRINA%b
